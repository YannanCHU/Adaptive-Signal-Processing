% this function was initially created for Task-2.1-(f)

function [x_hat, errors, weights] = leaky_LMS_ar(x, mu, gamma, AR_order)
...
for i = 1:1:N
    ...
    weights(:,i+1) = (1-mu*gamma) * weights(:,i) + mu * errors(i) * x_past(:,i);
end
